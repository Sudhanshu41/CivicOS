"""
CivicOS — Alembic Environment Script

Async-aware migration runner for SQLAlchemy 2.0 + asyncpg.
...
print(f"DEBUG: Metadata contains tables: {list(Base.metadata.tables.keys())}")
...
def run_migrations_offline() -> None:
    """Run migrations using a SQL script (no DB connection required)."""
